...
This handbook documents the discipline that `claude-skill-discipline` enforces. It pairs with [`examples/categories.yaml`](../examples/categories.yaml) (the machine-readable spec) and the three pre-commit hooks shipped in [`hooks/`](../hooks/).
